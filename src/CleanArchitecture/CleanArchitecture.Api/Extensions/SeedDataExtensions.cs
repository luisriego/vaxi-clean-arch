    ...
    public static void SeedData(this IApplicationBuilder app)
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            vehiculos.Add(new
            {
                ...
                PrecioMontenimiento = faker.Random.Decimal(100, 200),
                PrecioMantenimientoTipoMoneda = "USD",
                Accesorios = new List<int>{ (int)Accesorio.WiFi, (int)Accesorio.AireAcondicionado, (int)Accesorio.AppleCar },
        ...
        const string sql = """
            INSERT INTO public.vehiculos
                       ...
                       ,precio_tipo_moneda
                       ,mantenimiento_monto
                       ,mantenimiento_tipo_moneda
                       ,accesorios
                       ,fecha_ultimo_alquiler)
                 VALUES
                       (@Id
                       ,@Vin
                       ,@Modelo
