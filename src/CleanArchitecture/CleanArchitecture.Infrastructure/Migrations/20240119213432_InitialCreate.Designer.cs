...
namespace CleanArchitecture.Infrastructure.Migrations
{
    ...
    [Migration("20240119213432_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Comentarios.Comentario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_comentarios_user_id");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Alquileres.Alquiler", b =>
                {
                    b.HasOne("CleanArchitecture.Domain.Usuarios.Usuario", null)
                        .WithMany()
